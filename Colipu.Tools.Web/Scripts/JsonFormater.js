var JsonFormater = (function () {
    ...
    JsonFormater.prototype.init = function () {
        this.tab = this.multiplyString(this.options.tabSize, this.options.singleTab);
        this.bindEvent();
        if ($("#jf-style").length == 0)
            $("head").append(JsonFormater.styleLink);
    };
    JsonFormater.prototype.isArray = function (obj) {
        return obj &&
            typeof (obj) === 'object' &&
            typeof (obj.length) === 'number' && !(obj.propertyIsEnumerable('length'));
    };
    JsonFormater.prototype.getRow = function (indent, data, isPropertyContent) {
        var tabs = "";
    ...
    JsonFormater.prototype.formatLiteral = function (literal, quote, comma, indent, isArray, style) {
    ...
    JsonFormater.prototype.formatFunction = function (indent, obj) {
        var tabs;
        var i;
    ...
    JsonFormater.prototype.multiplyString = function (num, str) {
        var result = '';
        for (var i = 0; i < num; i++) {
            result += str;
        }
    ...
    JsonFormater.prototype.traverseChildren = function (element, func, depth) {
    ...
    JsonFormater.prototype.makeContentVisible = function (element, visible) {
    ...
    JsonFormater.prototype.ProcessObject = function (obj, indent, addComma, isArray, isPropertyContent) {
        var html = "";
    ...
    JsonFormater.prototype.bindEvent = function () {
        var that = this;
    ...
    JsonFormater.prototype.doFormat = function (json) {
        var html;
        var obj;
        try {
    ...
    JsonFormater.prototype.expandAll = function () {
    ...
    JsonFormater.prototype.collapseAll = function () {
        if (this.isFormated == false) {
            return;
        }
        var that = this;
    ...
    JsonFormater.prototype.collapseLevel = function (level) {
        if (this.isFormated == false)
            return;
        var that = this;
    ...
    JsonFormater.styleLink = '<link id="jf-style" href="http://leo108.github.io/jsonFormater/jsonFormater.css" rel="stylesheet" />';
    return JsonFormater;
})();
//# sourceMappingURL=JsonFormater.js.map